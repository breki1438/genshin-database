export default function CharacterInfoBox({ character }: { character: any }) {
    ...
    return (
        <div className='border border-[#888888] bg-gradient-to-br from-[#232A37]/[75%] to-[#1E242F]/[75%] rounded-xl my-5 shadow-outer text-4xl w-96 md:w-80 h-fit'>
            <div className='flex flex-col'>
                <div className='text-center py-2 font-bold drop-shadow-text'>
                    Materials
                </div>
                <div className="flex flex-col text-2xl pt-2 m-auto">
                    <div className="border border-[#888888] bg-gradient-to-br from-[#2D3647]/[75%] to-[#28303F]/[75%] rounded-xl flex flex-row shadow-around m-5 mt-0 p-1 overflow-wrap items-center">
