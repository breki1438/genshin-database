/*
  ...
  - Added the required column `build` to the `CharacterArtifactSets` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_CharacterArtifactSets" ("artifactName", "characterName", "id") SELECT "artifactName", "characterName", "id" FROM "CharacterArtifactSets";
